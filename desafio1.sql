...
INSERT INTO
    `SpotifyClone`.`plano` (`plano_nome`, `valor`)
VALUES
    ('gratuito', 0.00),
    ('pessoal', 6.99),
    ('familiar', 7.99),
...
INSERT INTO
    `SpotifyClone`.`album` (`artista_id`, `album_nome`, `lacamento`)
VALUES
    (1, 'Envious', 1990),
    (1, 'Exuberant', 1993),
...
CREATE TABLE `SpotifyClone`.`musicas`(
    ...
    `musicas_nome` VARCHAR(60) NOT NULL,
...
INSERT INTO
    `SpotifyClone`.`musicas` (`album_id`, `musicas_nome`, `duracao`)
VALUES
    (1, "Soul For Us", 200),
...
INSERT INTO
    `SpotifyClone`.`usuario` (`usuario_nome`, `idade`, `plano_id`, `data_assinatura`)
VALUES
...
CREATE TABLE `SpotifyClone`.`historico`(
        `historico_info` DATETIME NOT NULL,
        `usuario_id` INT NOT NULL,
...
INSERT INTO
    `SpotifyClone`.`historico` (`historico_info`, `usuario_id`, `musicas_id`)
VALUES
